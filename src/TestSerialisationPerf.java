...
{
    public static final int REPETITIONS = 1 * 10 * 1;
    ...
    {
    	//NonBlockingHashMap<Integer, Integer> hm = new NonBlockingHashMap<>(10);
    	
    	//SizeOf.deepSizeOf(1);
    	
    	HashMap<Integer, String> hm = new HashMap<>(10000);
    	...
    	long startHashMapFilterLoad = System.nanoTime();
    	double endHashMapFilterRead = (System.nanoTime() - startHashMapFilterLoad) * 1.0e-6;
		System.out.println("HashMap get size =" + endHashMapFilterRead +" msecs, size is ");
